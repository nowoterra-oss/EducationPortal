        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Counselors_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LGSPercentile = table.Column<decimal>(type: "decimal(5,2)", nullable: true),
                    IsBilsem = table.Column<bool>(type: "INTEGER", nullable: false),
                    BilsemField = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    LanguageLevel = table.Column<string>(type: "TEXT", maxLength: 10, nullable: true),
                    TargetMajor = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    TargetCountry = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    ReferenceSource = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlanDocumentUrl = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AcademicDevelopmentPlans", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllDayEvent = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Achievement = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompetitionsAndAwards", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Notes = table.Column<string>(type: "TEXT", maxLength: 5000, nullable: false),
                    Assignments = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: true),
                    NextMeetingDate = table.Column<DateTime>(type: "TEXT", nullable: true),
                    SendEmailToParent = table.Column<bool>(type: "INTEGER", nullable: false),
                    SendSMSToParent = table.Column<bool>(type: "INTEGER", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    IsDeleted = table.Column<bool>(type: "INTEGER", nullable: false),
                    CreatedBy = table.Column<string>(type: "TEXT", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CounselingMeetings", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExamName = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    Grade = table.Column<int>(type: "INTEGER", nullable: true),
                    AcademicYear = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
                    Score = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    MaxScore = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InternationalExams", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "TEXT", nullable: false),
                    StudentId = table.Column<int>(type: "INTEGER", nullable: false),
                    ParentType = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    Occupation = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    IsParentsSeparated = table.Column<bool>(type: "INTEGER", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    IsDeleted = table.Column<bool>(type: "INTEGER", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                name: "StudentClubMemberships",
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    StudentId = table.Column<int>(type: "INTEGER", nullable: false),
                    ClubType = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    ClubName = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    Role = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    StartDate = table.Column<DateTime>(type: "TEXT", nullable: true),
                    EndDate = table.Column<DateTime>(type: "TEXT", nullable: true),
                    MembershipDocumentUrl = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    IsDeleted = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentClubMemberships", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StudentClubMemberships_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "StudentCounselorAssignments",
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentCounselorAssignments", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LicenseLevel = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    LicenseDocumentUrl = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    Achievements = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
                    StartDate = table.Column<DateTime>(type: "TEXT", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    IsDeleted = table.Column<bool>(type: "INTEGER", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    StudentId = table.Column<int>(type: "INTEGER", nullable: false),
                    SiblingName = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    Grade = table.Column<int>(type: "INTEGER", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UniversityName = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    Department = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    RequirementsUrl = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    ApplicationStartDate = table.Column<DateTime>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TeacherId = table.Column<int>(type: "INTEGER", nullable: false),
                    Date = table.Column<DateTime>(type: "TEXT", nullable: false),
                    PerformancePercentage = table.Column<int>(type: "INTEGER", nullable: false),
                    Notes = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    IsDeleted = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResourceUrl = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "StudentTeacherAssignments",
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentTeacherAssignments", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    AGPId = table.Column<int>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AGPMilestones", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AGPMilestones_AcademicDevelopmentPlans_AGPId",
                        column: x => x.AGPId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Score = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
                    Status = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    IsDeleted = table.Column<bool>(type: "INTEGER", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UniversitySpecificExams", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UniversitySpecificExams_UniversityApplications_ApplicationId",
            ...
            migrationBuilder.CreateTable(
                name: "StudentHomeworkSubmissions",
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ...
                    SubmissionUrl = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    CompletionPercentage = table.Column<int>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentHomeworkSubmissions", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExamResults_InternalExams_ExamId",
                        column: x => x.ExamId,
                        principalTable: "InternalExams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AcademicDevelopmentPlans_StudentId",
                table: "AcademicDevelopmentPlans",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_AGPMilestones_AGPId",
                table: "AGPMilestones",
                column: "AGPId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClassPerformances_CourseId",
                table: "ClassPerformances",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_ClassPerformances_StudentId",
                table: "ClassPerformances",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_ClassPerformances_TeacherId",
                table: "ClassPerformances",
                column: "TeacherId");

            migrationBuilder.CreateIndex(
                name: "IX_CompetitionsAndAwards_StudentId",
                table: "CompetitionsAndAwards",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_CounselingMeetings_CounselorId",
                table: "CounselingMeetings",
                column: "CounselorId");

            migrationBuilder.CreateIndex(
                name: "IX_CounselingMeetings_StudentId",
                table: "CounselingMeetings",
                column: "StudentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseResources_CurriculumId",
                table: "CourseResources",
                column: "CurriculumId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InternalExams_CourseId",
                table: "InternalExams",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_InternalExams_TeacherId",
                table: "InternalExams",
                column: "TeacherId");

            migrationBuilder.CreateIndex(
                name: "IX_InternationalExams_StudentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentClubMemberships_StudentId",
                table: "StudentClubMemberships",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentCounselorAssignments_CounselorId",
                table: "StudentCounselorAssignments",
                column: "CounselorId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentCounselorAssignments_StudentId",
                table: "StudentCounselorAssignments",
                column: "StudentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentHomeworkSubmissions_HomeworkId",
                table: "StudentHomeworkSubmissions",
                column: "HomeworkId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentHomeworkSubmissions_StudentId",
                table: "StudentHomeworkSubmissions",
                column: "StudentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentTeacherAssignments_CourseId",
                table: "StudentTeacherAssignments",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentTeacherAssignments_StudentId",
                table: "StudentTeacherAssignments",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentTeacherAssignments_TeacherId",
                table: "StudentTeacherAssignments",
                column: "TeacherId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UniversityApplications_StudentId",
                table: "UniversityApplications",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_UniversitySpecificExams_ApplicationId",
                table: "UniversitySpecificExams",
